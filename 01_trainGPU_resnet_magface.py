# 01_trainGPU_resnet_magface.py
# -------------------------------------------------------------
# Tahap 1 (GPU A100): Training ResNet + MagFace
...
def main():
    p = argparse.ArgumentParser(
        description="Train ResNet + MagFace on GPU A100")
    ...
    print(f"🚀 ResNet + MagFace Training Start on: {device}")
    print(
    ...
    # Variabel Save Best
    best_acc = 0.0
    best_save_path = os.path.join(args.out_dir, "best_resnet_magface.pt")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % 5 == 0 or epoch == args.epochs:
            save_name = f"resnet_magface_epoch{epoch}.pt"
